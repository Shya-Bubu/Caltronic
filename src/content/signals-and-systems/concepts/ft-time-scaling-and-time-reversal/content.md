...
> **Why This Matters**: Time scaling creates bandwidth-duration duality; time reversal conjugates the spectrum. This is a fundamental building block for understanding how signals behave in the frequency domain.

## The Big Idea

[[visual:time-compression-signal]]

Let's start with the core intuition. Time scaling creates bandwidth-duration duality; time reversal conjugates the spectrum. This might sound abstract at first, but it connects directly to how every modern communication system, audio processor, and control system works.

[[visual:freq-expansion-spectrum]]
...
[[visual:freq-compression-spectrum]]
...
[[visual:scaling-duality-diagram]]

[[visual:rect-scaling-example]]

## Diving Deeper

[[visual:time-reversal-signal]]
...
- Time scaling creates bandwidth-duration duality; time reversal conjugates the spectrum
