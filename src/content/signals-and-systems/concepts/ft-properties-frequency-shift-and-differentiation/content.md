...
> **Why This Matters**: Frequency shift (modulation) and differentiation/integration in the FT domain. This is a fundamental building block for understanding how signals behave in the frequency domain.

## The Big Idea

[[visual:modulation-time-domain]]

Let's start with the core intuition. Frequency shift (modulation) and differentiation/integration in the FT domain. This might sound abstract at first, but it connects directly to how every modern communication system, audio processor, and control system works.

[[visual:modulation-freq-shift]]
...
[[visual:differentiation-freq-domain]]

## Diving Deeper

[[visual:jomega-multiplication]]
...
- Frequency shift (modulation) and differentiation/integration in the FT domain
